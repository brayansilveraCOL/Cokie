# Generated by Django 2.0.9 on 2020-03-09 19:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(blank=True, null=True, upload_to='pharma/pictures')),
                ...
                ('is_public', models.BooleanField(default=True, help_text='Public Cicrcles are listed in the main page so everyone know about their existence.')),
                ...
                ('members_limit', models.PositiveIntegerField(default=0, help_text='If circle is limited, this willl be the limit on the number of members')),
            ],
            options={
