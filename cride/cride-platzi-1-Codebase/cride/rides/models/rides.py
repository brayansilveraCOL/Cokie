...
class Ride(UtilsModel):
    offered_by = models.ForeignKey("users.User", on_delete=models.SET_NULL, null=True)
    offered_in = models.ForeignKey("pharma.Circle", on_delete=models.SET_NULL, null=True)
    ...
    is_active = models.BooleanField(
        'active status',
        default=True,
        help_text='Used for diabling the ride or marking it as finished'
    )
